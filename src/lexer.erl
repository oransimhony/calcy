-file("/usr/local/Cellar/erlang/21.2.6/lib/erlang/lib/parsetools-2.1.8/include/leexinc.hrl", 0).
...
-file("/usr/local/Cellar/erlang/21.2.6/lib/erlang/lib/parsetools-2.1.8/include/leexinc.hrl", 14).
...
yystate(23, [C|Ics], Line, Tlen, Action, Alen) when C >= 97, C =< 100 ->
    yystate(8, Ics, Line, Tlen+1, Action, Alen);
yystate(23, [C|Ics], Line, Tlen, Action, Alen) when C >= 102, C =< 114 ->
    yystate(8, Ics, Line, Tlen+1, Action, Alen);
yystate(23, [C|Ics], Line, Tlen, Action, Alen) when C >= 116, C =< 122 ->
    yystate(8, Ics, Line, Tlen+1, Action, Alen);
...
yyaction_0(TokenChars, TokenLine) ->
     { token, { stack, TokenLine, list_to_atom (TokenChars) } } .

-compile({inline,yyaction_1/2}).
-file("src/lexer.xrl", 13).
yyaction_1(TokenChars, TokenLine) ->
     { token, { exit, TokenLine, list_to_atom (TokenChars) } } .
...
-file("/usr/local/Cellar/erlang/21.2.6/lib/erlang/lib/parsetools-2.1.8/include/leexinc.hrl", 313).
